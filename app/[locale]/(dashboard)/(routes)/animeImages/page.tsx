...
import { ApertureIcon, Download} from "lucide-react";
...
const AnimeImagesPage = () => {
    ...
    const onSubmit = async (values : z.infer<typeof formSchema>) => {
        try{
           ...
           const response = await axios.post("/api/animeImages", values);
    ...
    return ( 
        <div className="pb-1 md:px-10 px-1 bg-[#b4ded3]">
            <Heading
            title ={animebot("title")}
            description={animebot("description")}
            icon={ApertureIcon}
                           ...
                           <FormItem className="col-span-12 lg:col-span-10 focus-visible:ring-0 rounded-md shadow-md border-0 outline-none shadow-zinc-500">
                              <FormControl className="m-0 p-0">
                                  <Input className= "border-0 outline-none focus-visible:ring-0 focus-visible:ring-[#E3FEF7] px-3 bg-[#E3FEF7]"
                                        disabled={isLoading} 
                                        placeholder="A beautiful girl standing in a park, green eyes, wearing white shirt and blue skirt, blue sky."
                                        autoComplete="off"
                                        {...field}
                                         />
                              </FormControl>
